    ...
    <body>
        ...
        <div class="page3">
            <div class="entery-card-kaydol">
                <h2>Kayıt</h2>
                <form action="{{ url('firmakayıt') }}" method="POST" autocomplete="off">
                    @csrf
                    <input name='firmaismi' type="text" placeholder="*Firma İsimi">
                    <input name= 'email' type="text" placeholder="*E-mail">
                    <input name='yetkiliadsoyad' type="text" placeholder="*Yetkili Tel No: 535 023 49 11">
                    <input name='yetkilitel' type="text" placeholder="*Yetkili İsmi - Soyisim">
                    <input name='password' type="password" placeholder="*Şifre">
                    <input name='c_password' type="password" placeholder="*Şifre Tekrar">
                    <input name='referansno' type="text" placeholder="Varsa Referans kodu girin:">
                    <button class="forgot-password-btn">Kaydol</button>
                </form>
            </div>
        </div>
    </body>