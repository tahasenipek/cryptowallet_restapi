    ...
    <body>
        ...
        <div class="page3">
            <div class="entery-card">
                <h2>Giriş</h2>
                <form action="{{ url('/firmagirisekrani')}}" method=POST>
                    @csrf
                    <input name="email" type="email" placeholder="email : ornek@gmail.com">
                ...
                <div class="giris-btns"> 
                    <button class="forgot-password-btn" onclick="window.location.href='firmakaydol'">Kaydol</button>
                </div>
