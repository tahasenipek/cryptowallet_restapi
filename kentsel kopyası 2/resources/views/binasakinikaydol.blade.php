    ...
    <body>
        ...
        <div class="page3">
            <div class="entery-card-kaydol">
                <h2>Kayıt</h2>
                <form action="{{ url('kullanıcı/binasakini') }}" method="POST" autocomplete="off">
                    @csrf
                    <input name='name' type="text" placeholder="*İsim">
                    <input name='surname' type="text" placeholder="*Soyİsim">
                    <input name='email' type="text" placeholder="*Email">
                    <input name='phonenumber' type="text" placeholder="*Telefon Numarası: 535 023 49 11">
                    <input name='password' type="password" placeholder="*Şifre">
                    <input name='c_password' type="password" placeholder="*Şifre Tekrar">
                    <input name='binareferansno 'type="text" placeholder="Varsa Binanızdan size verilen kodu girin:">
